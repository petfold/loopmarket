...
- **P1 Swarm book** — run the demo against a Bee node (`swarm_offer_book`), per-maker books + merge aggregation, spacetime categories generated into the shared OntoDAG, persistent ontology with pinned roots end-to-end.
