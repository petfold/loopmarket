...
- `src/loopmarket/schema.py` — the offer form: `TimeWindow`, `GeoDisc`, `Thing`, `Tokens`, `Offer` (+ `give`/`want` helpers; `ask`/`bid` kept as order-book synonyms), canonical encoding, content-addressed ids.
