...
\begin{tikzpicture}
  ...
  % runs one, they compete, and clearing trusts none of them.
  ...
  \node[root, minimum width=26mm, align=center] (set) at (92mm,0) {clearing\\{\footnotesize re-verifies every leg}};
  ...
  \node[note, text width=120mm] at (66mm,-34mm) {A solver reads the pinned books, hunts loops and proposes. It is trusted with nothing: clearing re-derives every leg against its own snapshot of the books and catalogue. The loopmarket repo ships a deterministic baseline solver, the species the others have to beat.};
\end{tikzpicture}
\end{document}
